...
op = declare_op(
    ...
    forward=(
        "evograd.ops.level3.llama3_decoder_layer.forward_ref:"
        "llama3_decoder_layer_forward_ref"
    ),
    runtime_forward=(
        "evograd.ops.level3.llama3_decoder_layer.forward_ref:"
        "llama3_decoder_layer_runtime_ref"
    ),
    level=3,
    family="llm_block",
    ...
    parameter_args=(
        "input_norm_weight", "q_weight", "k_weight", "v_weight", "o_weight",
        "post_norm_weight", "gate_weight", "up_weight", "down_weight",
    ),
    forward_semantics=(
