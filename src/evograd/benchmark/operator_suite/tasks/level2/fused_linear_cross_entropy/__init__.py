...
def _liger_factory():
    from evograd.benchmark.operator_suite.tasks.level2.fused_linear_cross_entropy.liger import (
...
op = declare_op(
    ...
    forward=(
        "evograd.benchmark.operator_suite.tasks.level2.fused_linear_cross_entropy.forward_ref:"
