...
from evograd.benchmark.operator_suite.tasks.level2.gemm_leaky_relu.triton_tutorial import (
...
op = declare_op(
    ...
    family="gemm",
    forward=(
        "evograd.benchmark.operator_suite.tasks.level2.gemm_leaky_relu.forward_ref:"
        "gemm_leaky_relu_forward_ref"
    ),
    runtime_forward=(
        "evograd.benchmark.operator_suite.tasks.level2.gemm_leaky_relu.forward_ref:"
        "gemm_leaky_relu_runtime_ref"
    ),
    dims=("M", "K", "N"),
    args=(
        Active("a", "[M, K]"),
