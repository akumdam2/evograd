...
op = declare_op(
    ...
    forward="evograd.benchmark.operator_suite.tasks.level2.layernorm_linear.forward_ref:layernorm_linear_forward_ref",
    level=2,
    family="gemm",
    dims=('M', 'K', 'N'),
    args=(
    ...
    parameter_args=("weight", "bias", "linear_weight"),
