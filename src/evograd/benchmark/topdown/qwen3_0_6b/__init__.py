...
appears at
:func:`~evograd.benchmark.topdown.qwen3_0_6b.levels.level4.model.require_transformers`
with the extra to install.

    PYTHONPATH=src python -m evograd.benchmark.topdown.qwen3_0_6b --out report.json
"""
