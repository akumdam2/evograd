...
op = declare_op(
    ...
    level=2,
    family="attention",
    forward="evograd.benchmark.topdown.qwen3_0_6b.levels.level2.attention.reference:qwen3_attention_forward_ref",
    ...
    runtime_forward=(
        "evograd.benchmark.topdown.qwen3_0_6b.levels.level2.attention.reference:"
