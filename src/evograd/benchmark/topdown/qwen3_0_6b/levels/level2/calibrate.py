...
def _harvested_mlp(op, artifact: Path, *, device: str):
    from evograd.benchmark.topdown.qwen3_0_6b.levels.level2.swiglu_mlp import derive_mlp_invocation
...
def _harvested_attention(op, artifact: Path, *, device: str):
    from evograd.benchmark.topdown.qwen3_0_6b.levels.level2.attention import derive_attention_invocation
...
def _harvested_qkv(op, artifact: Path, *, device: str):
    from evograd.benchmark.topdown.qwen3_0_6b.levels.level2.qkv_norm_rope import derive_qkv_invocation
