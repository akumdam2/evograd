"""Deriving the qwen3_swiglu_mlp case from the canonical layer artifact.
...
:mod:`evograd.evaluation.workloads.qwen3_0_6b.level2.swiglu_mlp`.
...
Extract and verify ``qwen3_swiglu_mlp`` from the verified Layer-14 replay.
    ...
    PYTHONPATH=src python -m evograd.benchmark.topdown.qwen3_0_6b.levels.level2.swiglu_mlp derive \
