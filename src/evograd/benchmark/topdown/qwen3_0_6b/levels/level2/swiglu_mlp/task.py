...
op = declare_op(
    ...
    family="mlp",
    forward=(
        "evograd.benchmark.topdown.qwen3_0_6b.levels.level2.swiglu_mlp.reference:qwen3_swiglu_mlp_forward_ref"
    ),
    ...
    # timing is trusted.
    runtime_forward=(
        "evograd.benchmark.topdown.qwen3_0_6b.levels.level2.swiglu_mlp.reference:qwen3_swiglu_mlp_forward_hf"
    ),
    dims=_DIMS,
    args=(
        Active("x", "[B, T, H]"),
