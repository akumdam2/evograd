"""The Qwen3-0.6B Level-1 mapping: check it, calibrate it, verify it.
    ...
    PYTHONPATH=src python -m evograd.benchmark.topdown.qwen3_0_6b.levels.level1.mapping calibrate \
        --op causal_gqa_attention \
        --report results/qwen3-level4/causal_gqa_attention-tolerance.json
    PYTHONPATH=src python -m evograd.benchmark.topdown.qwen3_0_6b.levels.level1.mapping verify \
        --source results/qwen3-level4/layer14.pt \
        --report results/qwen3-level4/layer14-sdpa-verify.json
    PYTHONPATH=src python -m evograd.benchmark.topdown.qwen3_0_6b.levels.level1.mapping loss
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m evograd.benchmark.topdown.qwen3_0_6b.levels.level1.mapping",
        description=__doc__,
