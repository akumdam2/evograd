...
op = declare_op(
    ...
    level=2,
    family="attention",
    forward="evograd.benchmark.topdown.llama3_2_1b.levels.level2.attention.reference:llama3_attention_forward_ref",
    ...
    runtime_forward=(
        "evograd.benchmark.topdown.llama3_2_1b.levels.level2.attention.reference:"
