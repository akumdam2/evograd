...
## The declared operator: `llama3_decoder_layer`

Declared in `evograd/ops/level3/llama3_decoder_layer/`. Level 3, family
`llm_block`, dims `(B, T, hidden, head_dim, q_out, kv_out, intermediate)`.
...
| `replay.py` | reruns that layer alone, in a fresh process, and checks it against the full model |
