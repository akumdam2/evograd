...
:mod:`evograd.evaluation.workloads.llama3_8b.level1`.
"""
...
OBSERVED_BINDINGS: tuple[ObservedBinding, ...] = (
    ObservedBinding(WORKLOAD, "causal_gqa_attention", "llama_3_8b_observed"),
    ObservedBinding(WORKLOAD, "cross_entropy", "llama_3_8b_observed",
                    declared_tolerances=True),
    ObservedBinding(WORKLOAD, "linear_no_bias", "llama_3_8b_observed"),
    ObservedBinding(WORKLOAD, "rmsnorm", "llama_3_8b_observed"),
    ObservedBinding(WORKLOAD, "rope", "llama_3_8b_observed"),
    ObservedBinding(WORKLOAD, "swiglu", "llama_3_8b_observed",
                    declared_tolerances=True),
)
