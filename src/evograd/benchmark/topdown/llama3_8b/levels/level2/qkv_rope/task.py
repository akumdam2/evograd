...
op = declare_op(
    ...
    family="attention",
    forward=(
        "evograd.benchmark.topdown.llama3_8b.levels.level2.qkv_rope.reference:llama3_qkv_rope_forward_ref"
    ),
    ...
    runtime_forward=(
        "evograd.benchmark.topdown.llama3_8b.levels.level2.qkv_rope.reference:"
