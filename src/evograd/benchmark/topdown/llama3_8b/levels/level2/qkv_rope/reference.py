...
# It does: `llama3_qkv_rope_forward_production` below is the spelling
# `LlamaAttention.forward` executes, and `tests/llama3/test_levels.py`
# runs both over the correctness grid and requires them to agree exactly.
