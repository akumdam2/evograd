...
op = declare_op(
    ...
    level=2,
    family="mlp",
    forward="evograd.benchmark.topdown.llama3_8b.levels.level2.swiglu_mlp.reference:llama3_swiglu_mlp_forward_ref",
    runtime_forward="evograd.benchmark.topdown.llama3_8b.levels.level2.swiglu_mlp.reference:llama3_swiglu_mlp_forward_hf",
    dims=_DIMS,
    args=(
        Active("x", "[B, T, H]"),
