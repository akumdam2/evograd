"""Replaying the captured Llama-3 layer and judging what comes back.

The artifact, and everything needed to rebuild the layer it came from, belong
to :mod:`evograd.benchmark.topdown.llama3_8b.levels.level3`. What is here is
the judgment: how far two tensors may differ before the difference is a defect
rather than bfloat16, how much of the spread is the replay's own
non-determinism, and the report that records the verdict.
"""
...
from evograd.benchmark.topdown.llama3_8b.levels.level3.artifact import (
    ArtifactError,
    LayerArtifact,
    tensor_meta,
    to_device,
...
REPORT_SCHEMA = "evograd-llama3-layer-replay-report/2"
...
def run_replay(
    ...
    *,
    ...
    if instances.get("LlamaForCausalLM") or instances.get("LlamaModel"):
        failures.append(
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m evograd.evaluation.workloads.llama3_8b.level3.replay",
        description=__doc__,
