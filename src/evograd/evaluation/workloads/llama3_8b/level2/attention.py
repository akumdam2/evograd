...
The case itself belongs to :mod:`evograd.benchmark.topdown.llama3_8b.levels.level2.attention.capture`.
...
from evograd.benchmark.topdown.llama3_8b.levels.level2.attention.capture import (
...
def run_verify(
    ...
    *,
    ...
    from evograd.benchmark.topdown.llama3_8b.levels.level2.attention.reference import (
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m evograd.benchmark.topdown.llama3_8b.levels.level2.attention",
        description=__doc__,
