"""Level-2 residual_rmsnorm judgment for Llama-3-8B: shared logic, bound to this model."""

from __future__ import annotations

from evograd.evaluation.workloads.common import level2_residual_rmsnorm as _common
