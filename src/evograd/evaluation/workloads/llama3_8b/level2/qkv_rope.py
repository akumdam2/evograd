...
The case itself belongs to :mod:`evograd.benchmark.topdown.llama3_8b.levels.level2.qkv_rope.capture`.
...
from evograd.benchmark.topdown.llama3_8b.levels.level2.qkv_rope.capture import (
    GRAD_NAMES,
    OUTPUT_NAMES,
    QkvExtractionError,
    TASK_NAME,
...
def run_verify(
    ...
    *,
    ...
    from evograd.benchmark.topdown.llama3_8b.levels.level2.qkv_rope.reference import (
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m evograd.benchmark.topdown.llama3_8b.levels.level2.qkv_rope",
        description=__doc__,
