"""Replaying the captured Qwen3 layer and judging what comes back.

The artifact, and everything needed to rebuild the layer it came from, belong
to :mod:`evograd.benchmark.topdown.qwen3_0_6b.levels.level3`. What is here is
...
non-determinism, and the report that records the verdict.
      ...
      PYTHONPATH=src python -m evograd.benchmark.topdown.qwen3_0_6b.levels.level3.replay         --artifact results/qwen3-level4/layer14.pt         --report results/qwen3-level4/layer14-replay.json
