"""One command for the Qwen3 Level-1 checks.

    PYTHONPATH=src python -m evograd.evaluation.workloads.qwen3_0_6b.level1.cli mapping
"""
...
from evograd.benchmark.topdown.qwen3_0_6b.levels.level1.manifest import Level1Error, mapping
from evograd.evaluation.workloads.qwen3_0_6b.level1.calibrate import (
    run_calibration,
    summarize_calibration,
)
from evograd.evaluation.workloads.qwen3_0_6b.level1.verify import (
    REPORT_SCHEMA,
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m evograd.evaluation.workloads.qwen3_0_6b.level1.cli",
        description=__doc__,
