"""Numerical calibration for the observed Qwen3 Level-2 boundaries.
    ...
    PYTHONPATH=src python -m evograd.benchmark.topdown.qwen3_0_6b.levels.level2.calibrate inventory \
...
def _harvested_mlp(op, artifact: Path, *, device: str):
    from evograd.benchmark.topdown.qwen3_0_6b.levels.level2.swiglu_mlp.capture import derive_mlp_invocation
...
def _harvested_attention(op, artifact: Path, *, device: str):
    from evograd.benchmark.topdown.qwen3_0_6b.levels.level2.attention.capture import derive_attention_invocation
...
def _harvested_qkv(op, artifact: Path, *, device: str):
    from evograd.benchmark.topdown.qwen3_0_6b.levels.level2.qkv_norm_rope.capture import derive_qkv_invocation
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m evograd.benchmark.topdown.qwen3_0_6b.levels.level2.calibrate",
        description=__doc__,
