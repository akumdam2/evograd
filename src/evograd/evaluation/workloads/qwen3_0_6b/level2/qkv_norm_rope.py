"""Judging an implementation of ``qwen3_qkv_norm_rope`` against the captured boundary.

The case itself -- the boundary, the captured tensors, the provenance check --
belongs to :mod:`evograd.benchmark.topdown.qwen3_0_6b.levels.level2.qkv_norm_rope.capture`. What is here is the
...
from evograd.benchmark.topdown.qwen3_0_6b.levels.level2.qkv_norm_rope.capture import (
    GRAD_NAMES,
    OUTPUT_NAMES,
    QkvExtractionError,
    TASK_NAME,
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m evograd.benchmark.topdown.qwen3_0_6b.levels.level2.qkv_norm_rope",
        description=__doc__,
