"""Judging an implementation of ``qwen3_swiglu_mlp`` against the captured boundary.

The case itself -- the boundary, the captured tensors, the provenance check --
belongs to :mod:`evograd.benchmark.topdown.qwen3_0_6b.levels.level2.swiglu_mlp.capture`. What is here is the
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m evograd.benchmark.topdown.qwen3_0_6b.levels.level2.swiglu_mlp",
        description=__doc__,
