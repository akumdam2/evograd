"""Judging an implementation of ``fused_add_rms_norm`` against the captured boundary.

The case itself -- the boundary, the captured tensors, the provenance check --
belongs to :mod:`evograd.benchmark.topdown.qwen3_0_6b.levels.level2.residual_rmsnorm.capture`. What is here is the
...
from evograd.benchmark.topdown.qwen3_0_6b.levels.level2.residual_rmsnorm.capture import (
    DIRECT_GRADS,
    OUTPUT_NAMES,
