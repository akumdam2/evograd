...
The case itself belongs to :mod:`evograd.benchmark.topdown.llama3_2_1b.levels.level2.residual_rmsnorm.capture`.
...
from evograd.benchmark.topdown.llama3_2_1b.levels.level2.residual_rmsnorm.capture import (
    DIRECT_GRADS,
    OUTPUT_NAMES,
...
def run_verify(
    ...
    *,
    ...
    from evograd.benchmark.topdown.llama3_2_1b.levels.level2.residual_rmsnorm.reference import (
    ...
    case = op.benchmark_workloads("llama_3_2_1b_observed")[0]
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m evograd.benchmark.topdown.llama3_2_1b.levels.level2.residual_rmsnorm",
        description=__doc__,
