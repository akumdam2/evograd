...
The case itself belongs to :mod:`evograd.benchmark.topdown.llama3_2_1b.levels.level2.swiglu_mlp.capture`.
...
from evograd.benchmark.topdown.llama3_2_1b.levels.level2.swiglu_mlp.capture import (
    MlpExtractionError,
    TASK_NAME,
    check_provenance,
...
def run_verify(
    ...
    *,
    ...
    from evograd.benchmark import get_task
    from evograd.benchmark.topdown.llama3_2_1b.levels.level2.swiglu_mlp.reference import (
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m evograd.benchmark.topdown.llama3_2_1b.levels.level2.swiglu_mlp",
        description=__doc__,
    ...
    def source_args(sp):
        sp.add_argument(
            "--source", type=Path, default=Path("results/llama3-level4/layer8.pt")
        )
