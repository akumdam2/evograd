...
SITE_OPS: dict[str, str] = {
    ...
    # by o_proj -- at Llama's dims. The declaration is dimension-parameterized,
    # so it is shared rather than duplicated; the name is Qwen3's for historical
    # reasons and is a rename this repository still owes.
...
def _observed(op_name: str):
    ...
    try:
        return tuple(get_op(op_name).benchmark_workloads(suite=OBSERVED_SUITE))
