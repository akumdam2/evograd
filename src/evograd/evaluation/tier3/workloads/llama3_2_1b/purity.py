"""Llama's half of the purity gate: how many calls, and how to rebuild a provider.
    ...
    PYTHONPATH=src python -m evograd.evaluation.tier3.workloads.llama3_2_1b.purity \
        --provider structural
...
_LAYERS = LLAMA_3_2_1B["num_hidden_layers"]

#: This module, as ``python -m`` names it. The isolated run re-enters here.
CHILD_MODULE = "evograd.evaluation.tier3.workloads.llama3_2_1b.purity"
