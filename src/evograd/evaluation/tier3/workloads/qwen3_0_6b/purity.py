"""Qwen3's half of the purity gate: how many calls, and how to rebuild a provider.
    ...
    PYTHONPATH=src python -m evograd.evaluation.tier3.workloads.qwen3_0_6b.purity \
        --provider structural
...
it. That lives in :mod:`evograd.evaluation.tier3.gate.purity`.
...
CHILD_MODULE = "evograd.evaluation.tier3.workloads.qwen3_0_6b.purity"
