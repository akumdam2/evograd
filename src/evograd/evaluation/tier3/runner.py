...
The last of tier 3's three parts:
    ...
    model.py    the workload protocol, and the import path
    patch.py    kernels, sites, and the two ways to insert one
    runner.py   this file -- building, timing, and reporting
...
from evograd.evaluation.tier3.model import (
    TrainingWorkload,
...
def preflight(
    ...
    Reuses ``evaluation.common.provider.verify_pair_provider`` -- the same path tier 1's CLI
    ...
    """
    from evograd.evaluation.common.provider import candidate_provider, verify_pair_provider
...
def run_tier3(
    ...
    *,
    ...
    line.
    """
    from evograd.evaluation.tier1.fair import environment_fingerprint
